...
import { useAppContext } from "../context/AppContext"; // or correct relative path
      ...
      <div className="flex h-screen">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 pb-8 bg-[#292a2d] text-white relative">
          ...
          {message.length === 0 ? (
            ...
            <div ref={containerRef} className="relative flex flex-col item-center justify-start w-full mt-20 max-h-screen overflow-y-auto">
              ...
              ))}
              {
                loading && (
                  <div className="flex gap-4 max-w-3xl w-full py-3">
                    ...
                    <div className="loader flex justify-center items-center gap-1"></div>
